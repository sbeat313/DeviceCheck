...
builder.Services
    ...
    .Validate(
        o => o.NotificationEndpoints.TrueForAll(x => Uri.TryCreate(x, UriKind.Absolute, out _)),
        "DeviceCheck:NotificationEndpoints 必須都是合法的絕對 URL")
    .ValidateOnStart();

builder.Services.AddSingleton<DeviceRegistry>();
builder.Services.AddHttpClient<DeviceNotificationService>(client =>
{
